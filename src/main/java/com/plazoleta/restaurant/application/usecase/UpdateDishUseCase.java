...
/**
 * Implementa el caso de uso para modificar platos.
 */
public class UpdateDishUseCase implements UpdateDishServicePort {
    ...
    public DishUpdatedResponse updateDish(final UpdateDishCommand command) {
        ...
        Dish updatedDish = dishPersistencePort.save(dish.updatePriceAndDescription(command.price(), command.description()));
